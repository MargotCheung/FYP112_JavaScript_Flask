        ...
        <div class="container-fluid pt-3" style="background: #FFE8D6">
            <div class="row removable">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="fa fa-desktop text-primary"></i>                            
                                        <span class="nav-link-text"> <router-link to="/myProfile" style="color: #212529"> 我的資料</router-link></span>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">    
                                        <i class="fa fa-globe text-info"></i>
                                        <span class="nav-link-text"> <router-link to="/uploadPaper" style="color: #212529"> 上傳考古題</router-link></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:">
                                        <i class="fa fa-map-marker text-warning"></i>
                                        <span class="nav-link-text"> <router-link to="/lessonPage" style="color: #212529"> LessonPage</router-link></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:">
                                        <i class="fa fa-table text-dark"></i>
                                        <span class="nav-link-text"> <router-link to="/searchResult" style="color: #212529"> SearchResult</router-link></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row removable" >
                        <div class="col-lg-2">
                            <button class="btn btn-primary col text-center">程式設計I</button>
                        </div>

                        <div class="col-lg-2">
                            <button class="btn btn-secondary col text-center">微積分I</button>
                        </div>

                        <div class="col-lg-2">
                            <button class="btn btn-success col text-center">邏輯設計</button>
                        </div>
                        <div class="col-lg-2">
                            <button class="btn btn-danger col text-center">線性代數</button>
                        </div>
                        <div class="col-lg-2">
                            <button class="btn btn-warning col text-center">普通物理</button>
                        </div>
                        <div class="col-lg-2"><button class="btn btn-dark col text-center">&gt;</button></div>
                    </div>
                    <!-- End of 走馬燈 -->
