...
Revision ID: 96af015a9de4
Revises: a97146a6db9b
Create Date: 2023-08-31 23:51:30.544486
...
revision = '96af015a9de4'
down_revision = 'a97146a6db9b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['course_name'], ['course_info.course_id'], ),
