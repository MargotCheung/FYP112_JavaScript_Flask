...
class UserModel(db.Model):
    ...
    ability_math = db.Column(db.Float, default=1.0)
    ability_coding = db.Column(db.Float, default=1.0)
    ability_logic = db.Column(db.Float, default=1.0)
    ability_creative = db.Column(db.Float, default=1.0)
    ability_solve = db.Column(db.Float, default=1.0)
